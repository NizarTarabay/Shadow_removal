...
dir = '/media/nizar/Transcend/cocosynth/datasets/pavement_distress_synthetic/input/backgrounds'
...
for filename in glob.glob("*.png"):
    ...
    #--------------- Step 2: smooth -----------------#
    blur = cv2.GaussianBlur(closing, (31, 31), 9)
    # plt.figure(3)
    # plt.imshow(blur)
    ...
    cv2.imwrite(os.path.join(dir, filename), img_processed)
